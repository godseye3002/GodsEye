...
export function MCPDocumentation() {
    ...
    return (
        <Card
            className="flex flex-col mb-8 bg-[#0D0F14]/95 border-[#2ED47A]/15 shadow-[0_4px_40px_rgba(0,0,0,0.5)]"
        >
            <CardHeader className="px-6 py-8 border-b border-white/5">
                <Stack direction="row" spacing={2} alignItems="center">
                    <InsightsIcon sx={{ fontSize: 32, color: accentColor }} />
                    <div className="flex flex-col gap-1">
                        <CardTitle className="text-2xl font-bold text-white">GodsEye MCP: Integration Guide</CardTitle>
                        <CardDescription className="text-[#A2A7B4]">
                            Connect your AI coding agents directly to the GodsEye AEO Database.
                        </CardDescription>
                    </div>
                </Stack>
            </CardHeader>
            <CardContent className="p-6">
                <Stack spacing={6}>
                    ...
                    <Box>
                        <Typography level="h3" sx={{ color: textColor, fontWeight: 600, mb: 3, display: "flex", alignItems: "center", gap: 1 }}>
                            <Box component="span" sx={{ color: accentColor }}>⚙️</Box> Installation
                        </Typography>

                        <Typography level="body-md" sx={{ color: textSecondary, mb: 4 }}>
    ...
    "godseye": {
      ...
      "args": [
        ...
        "sse-only"
                    ...
                    <Box>
                        ...
                        <Box sx={{ position: "relative" }}>
                            <Box sx={{
                                ...
                                {`// Cursor & Windsurf:\n@godseye fetch the AEO analysis for product ID ${currentProductId || '[YOUR-PRODUCT-ID]'}\n\n// Claude Desktop:\nUse the GodsEye tool to fetch the analysis for product ID ${currentProductId || '[YOUR-PRODUCT-ID]'}`}
                            </Box>
                            <Button
                                size="sm"
                                variant="plain"
                    ...
                    <Box>
                        <Typography level="h3" sx={{ color: "#F35B64", fontWeight: 600, mb: 3, display: "flex", alignItems: "center", gap: 1 }}>
