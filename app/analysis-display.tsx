...
import { Box, Card, Typography, Button, Divider, Chip, Modal, ModalDialog, ModalClose, Stack } from "@mui/joy";
        ...
        >
          ...
          <Stack spacing={3}>
            <Box>
              ...
              <Typography level="body-sm" sx={{ mt: 1, color: "rgba(255, 255, 255, 0.78)" }}>
                This will delete the current analysis. Make sure to download it as PDF or Word before continuing.
              </Typography>
            </Box>
